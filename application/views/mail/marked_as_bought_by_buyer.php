...
<html>
    ...
    <body>
        ...
        <br>
        <a href="<?=site_url('product/'.$id)?>" style="background-color: DodgerBlue; text-decoration: none; font-family: 'Calibri'; font-size: 18px; color: black; padding: 10px; border-radius: 4px;">Click to update product status</a>
        <br>
        <br>
